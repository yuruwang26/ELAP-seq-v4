                ...
                if df["IP_arrest"].iloc[i] > df["IP_arrest"].iloc[i-1] and df["IP_arrest"].iloc[i] > df["IP_arrest"].iloc[i+1]:
                    if (df["IP_arrest"].iloc[i] - df["IP_arrest"].iloc[i-1])/df["IP_arrest"].iloc[i] > 0.15:
                        if (df["IP_arrest"].iloc[i] - df["IP_arrest"].iloc[i+1])/df["IP_arrest"].iloc[i] > 0.15: 
                            ...
                            print(df["chr"].iloc[i],df["p"].iloc[i],df["position"].iloc[i],df["/"].iloc[i],df["strand"].iloc[i],df["/2"].iloc[i],df["base"].iloc[i],df["in_arrest"].iloc[i],df["in_rt"].iloc[i],df["IP_arrest"].iloc[i],df["IP_rt"].iloc[i],df["in_sum"].iloc[i],df["IP_sum"].iloc[i],df["In_stop"].iloc[i],df["IP_stop"].iloc[i],df["peak"].iloc[i],df["samp"].iloc[i]) 
                            print(df["chr"].iloc[i+1],df["p"].iloc[i+1],df["position"].iloc[i+1],df["/"].iloc[i+1],df["strand"].iloc[i+1],df["/2"].iloc[i+1],df["base"].iloc[i+1],df["in_arrest"].iloc[i+1],df["in_rt"].iloc[i+1],df["IP_arrest"].iloc[i+1],df["IP_rt"].iloc[i+1],df["in_sum"].iloc[i+1],df["IP_sum"].iloc[i+1],df["In_stop"].iloc[i],df["IP_stop"].iloc[i+1],df["peak"].iloc[i+1],df["samp"].iloc[i+1]) 
                    elif (df["IP_arrest"].iloc[i] - df["IP_arrest"].iloc[i-1])/df["IP_arrest"].iloc[i] < 0.15:
