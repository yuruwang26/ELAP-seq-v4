...
###
### filter2.sh 
###    -  filter sites from library III+IV based on stop ratio and coverage, and select for sites covered by at least 1 uniquely mapped reads
### 
###  
### Usage:
...
awk '{ if(($15 >= 0.8 && $10 > 5 ) || ($15 > 0.2 && $15 < 0.8 && $13 > 9) || ($10 > 10 && $15 > 0.10 && $15 < 0.2 )) print $0;}' $2 > 6-18.out

awk '{ if(($15 >= 0.8 && $10 > 4 ) || ($15 >= 0.3 && $15 < 0.8 && $13 > 8) || ($10 > 2 && $15 >= 0.1 && $15 < 0.3)) print $0;}' $3 > 7-18.out
